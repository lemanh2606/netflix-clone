...
// ── SVG Icons trực tiếp từ Netflix HTML ──────────────────
...
function TelescopeIcon(): JSX.Element {
  return (
    <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
...
function ProfilesIcon(): JSX.Element {
  return (
    <svg width="72" height="72" viewBox="0 0 72 72" fill="none">
...
const VALUE_PROPS: ValueProp[] = [
  ...
  },
  {
    ...
    title: "Xem ở mọi nơi",
    description:
      "Phát trực tuyến không giới hạn phim và series trên điện thoại, máy tính bảng, máy tính xách tay và TV.",
    icon: <TelescopeIcon />,
  },
  {
    id: 4,
...
// ── Card ──────────────────────────────────────────────────
function ValueCard({ item }: { item: ValueProp }): JSX.Element {
  return (
    <div
      className="relative w-full rounded-xl overflow-hidden flex-1"
      style={{
        background:
          "linear-gradient(135deg, #1a0e2e 0%, #1e1035 40%, #2a1040 100%)",
        minHeight: "320px",
    ...
    >
      ...
      {/* Icon — absolute bottom right như Netflix */}
      <div className="absolute" style={{ bottom: "1.25rem", right: "1.25rem" }}>
        {item.icon}
      </div>
    </div>
  );
